    ...
    <div class="transaction-edit">
        ...
        <form action={{ route("transaction.update", $transaction) }} method="POST">
            ...
            <div class="form-field">
                ...
                <input type="text" id="date" name="vendor" value="{{ $transaction->vendor }}">
            </div>

            <div class="form-spend">
                <label for="spend" class="transaction-spend">Spend</label>
                <input type="text" id="spend" name="spend" value="{{ $transaction->spend }}">
            </div>

            <div class="form-field">
                <label for="deposit" class="transaction-deposit">Deposit</label>
                <input type="text" id="deposit" name="deposit" value="{{ $transaction->deposit }}">
            </div>

            <div class="form-field">
                <label for="balance" class="transaction-balance">Balance</label>
                <input type="text" id="balance" name="balance" value="{{ $transaction->balance }}">
            </div>
